...
class DocumentationIndexer:
    ...
    def get_style_and_qa_specs(self) -> str:
        ...
        style_path = self.doc_root / "02-design-specifications/01_BASIC_STYLE_GUIDE_SPECIFICATION.md"
        qa_path = self.doc_root / "02-design-specifications/09_QUALITY_ASSURANCE_MANAGEMENT_SPECIFICATION.md"
